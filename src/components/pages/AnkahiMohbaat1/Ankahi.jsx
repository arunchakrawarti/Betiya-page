        ...
        {arr.map((item, i) => (
          ...
          >
            ...
            <div className="p-4 sm:p-6 flex flex-col justify-between w-full sm:w-3/5">
              ...
              <p className="text-sm sm:text-md text-gray-600 mb-3 leading-6 text-justify sm:text-left">
                {item.description}
              </p>
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between gap-4 sm:gap-0 items-center sm:items-center text-xs mb-4">
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="mt-1 text-xs sm:text-sm">Rating</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className="text-black font-extrabold">{item.readTime}</p>
                  <p className="mt-1 text-xs sm:text-sm">पढ़ने का समय</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className="text-black font-extrabold">{item.readers}</p>
                  <p className="mt-1 text-xs sm:text-sm">लोगों ने पढ़ा</p>
                </div>
              </div>
                ...
                <button className="p-2 rounded-full">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M8.684 13.342C8.882 13.142 9 12.87 9 12.5V10c0-1.38 1.12-2.5 2.5-2.5S14 8.62 14 10v2.5c0 .37.118.642.316.842l2.35 2.35c.2.2.316.472.316.792v1.5c0 .28-.118.552-.316.752l-2.35 2.35c-.2.2-.472.316-.792.316h-1.5c-.28 0-.552-.118-.752-.316l-2.35-2.35c-.2-.2-.316-.472-.316-.792v-1.5c0-.32.118-.592.316-.792l2.35-2.35zM12 11c.28 0 .5.22.5.5v2c0 .28-.22.5-.5.5s-.5-.22-.5-.5v-2c0-.28.22-.5.5-.5z"
                    />
                  </svg>
                </button>
              </div>
